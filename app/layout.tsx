...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} bg-neutral-50 text-neutral-950 antialiased`}>
        ...
        <header className="sticky top-0 z-20 border-b border-neutral-200/60 bg-white/80 backdrop-blur">
          <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center gap-4 text-sm">
              <a className="text-neutral-700 transition hover:text-neutral-950" href="/pricing">
                Pricing
              </a>
